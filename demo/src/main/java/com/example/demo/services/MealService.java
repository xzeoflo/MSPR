...
public class MealService {
    ...
    public void associateUserToMeal(Integer mealId, Integer userId, LocalDateTime date, String requestingUserPartnerBrand) {
    ...
    public Meal updateMeal(Integer id, Meal details, String requestingUserPartnerBrand) {
        ...
        if (details.getMealType() != null) meal.setMealType(details.getMealType());
        if (details.getQuantityG() != null) meal.setQuantityG(details.getQuantityG());
        if (details.getAllergies() != null) meal.setAllergies(details.getAllergies());
        if (details.getCaloriesKcal() != null) meal.setCaloriesKcal(details.getCaloriesKcal());
        if (details.getProteinG() != null) meal.setProteinG(details.getProteinG());
        if (details.getCarbsG() != null) meal.setCarbsG(details.getCarbsG());
        if (details.getFiberG() != null) meal.setFiberG(details.getFiberG());
        if (details.getFatsG() != null) meal.setFatsG(details.getFatsG());
        if (details.getSugarG() != null) meal.setSugarG(details.getSugarG());
        if (details.getSodiumMg() != null) meal.setSodiumMg(details.getSodiumMg());
        if (details.getCholesterolMg() != null) meal.setCholesterolMg(details.getCholesterolMg());
