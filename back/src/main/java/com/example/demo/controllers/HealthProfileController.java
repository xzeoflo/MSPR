...
public class HealthProfileController {
    ...
    public ResponseEntity<HealthProfile> create(@PathVariable Integer userId, @RequestBody HealthProfile profile, Principal principal) {
        String brand = getRequestingUserPartner(principal);
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'CLIENT')")
    public ResponseEntity<HealthProfile> update(@PathVariable Integer id, @RequestBody HealthProfile profile, Principal principal) {
        String brand = getRequestingUserPartner(principal);
