...
public class UserService {
    ...
    public User updateUser(Integer id, User userDetails, String requestingUserPartnerBrand) {
        ...
        if (userDetails.getSubscriptionTier() != null)
            user.setSubscriptionTier(userDetails.getSubscriptionTier());

        if (userDetails.getPartnerBrand() != null
                || (userDetails.getRole() != null && user.getRole() != userDetails.getRole())) {
            if (userDetails.getRole() != null)
                user.setRole(userDetails.getRole());
            if (userDetails.getPartnerBrand() != null)
                user.setPartnerBrand(userDetails.getPartnerBrand());
            userValidator.validatePartnerBrand(user);
        }
