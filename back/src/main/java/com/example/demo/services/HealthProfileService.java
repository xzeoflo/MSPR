...
public class HealthProfileService {
    ...
    public HealthProfile updateProfile(Integer id, HealthProfile details, String brand) {
        ...
        if (details.getDiseaseType() != null) profile.setDiseaseType(details.getDiseaseType());
        if (details.getDiseaseSeverity() != null) profile.setDiseaseSeverity(details.getDiseaseSeverity());
        if (details.getBloodPressureAvg() != null) profile.setBloodPressureAvg(details.getBloodPressureAvg());
        if (details.getBloodGlucoseMg() != null) profile.setBloodGlucoseMg(details.getBloodGlucoseMg());
        if (details.getCholesterolMgDl() != null) profile.setCholesterolMgDl(details.getCholesterolMgDl());
        if (details.getDietaryRestrictions() != null) profile.setDietaryRestrictions(details.getDietaryRestrictions());
        if (details.getAllergies() != null) profile.setAllergies(details.getAllergies());
        if (details.getDietaryRecommendation() != null) profile.setDietaryRecommendation(details.getDietaryRecommendation());
